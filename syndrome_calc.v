module syndrome_calc (
    ...
    assign root[16] = 8'h4C; assign root[17] = 8'h98; assign root[18] = 8'h2D; assign root[19] = 8'h5A;
    assign root[20] = 8'hB4; assign root[21] = 8'h75; assign root[22] = 8'hEA; assign root[23] = 8'hC9;
    assign root[24] = 8'h8F; assign root[25] = 8'h03; assign root[26] = 8'h06; assign root[27] = 8'h0C;
    assign root[28] = 8'h18; assign root[29] = 8'h30; assign root[30] = 8'h60; assign root[31] = 8'hC0;
    ...
    always @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            // Moi chu ky nhan 1 byte, cap nhat bang cach lay ket qua nhan XOR voi data_in
            for (j = 0; j < 32; j = j + 1) begin
